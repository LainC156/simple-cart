    ...
    <section class="text-gray-700 body-font overflow-hidden" v-if="product">
        <div class="container px-12 py-24 mx-auto">
            <div class="lg:w-3/5 mx-auto flex flex-wrap">
                <img src="https://dummyimage.com/640x640" alt="ecommerce" class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded">
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 
                        ...
                        :key="category.id"
                    ></h2>
                    <h1 class="text-gay-900 text-3xl title-font font-medium mb-2"
                        v-text="product.name"
                    ></h1>
                    ...
                    <div class="flex mt-6 pt-4 border-t-2 border-gray-200">
                        ...
                        ></span>
                        <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 focus:outline-none hover:bg-indigo-600 rounded"
